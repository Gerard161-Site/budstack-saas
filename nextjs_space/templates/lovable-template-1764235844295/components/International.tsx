...
type CountryStatus = 'operational' | 'expanding' | 'planned';
...
const countries: Record<string, CountryData> = {
  'PT': { 
    ...
    status: 'operational', 
    order: 1,
    description: 'Fully operational medical cannabis facilities with INFARMED certification',
  ...
  'ES': { 
    ...
    status: 'expanding', 
    order: 2,
    description: 'Expanding operations across major regions',
    locations: ['Barcelona']
  },
  'DE': { 
    name: 'Germany', 
    status: 'planned', 
    order: 3,
    description: 'Planning phase for future expansion',
    locations: []
  }
};
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="w-full max-w-7xl mx-auto">
          ...
          {/* Interactive Map - Placeholder */}
            <div className="relative h-[450px] sm:h-[500px] md:h-[600px] mb-12 sm:mb-16 rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-slate-800 flex items-center justify-center">
              <p className="text-white/50">Interactive Map Section</p>
            </div>
