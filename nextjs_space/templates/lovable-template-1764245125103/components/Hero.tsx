...
export default function Hero({ businessName, logoUrl, heroImageUrl }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <source src="/lovable-assets/hero-video.mp4" type="video/mp4" />
        </video>
      ...
      >
        <div className="max-w-5xl text-left relative">
          ...
          {/* Transparent logo overlay - subtle watermark */}
          <motion.div
          ...
          >
            <Image 
              src="/lovable-assets/hb-logo-square.png"
              alt=""
              width={560}
              height={560}
