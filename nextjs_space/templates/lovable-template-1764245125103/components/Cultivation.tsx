    ...
    <section className="bg-background py-12 sm:py-16 md:py-20 px-2">
      <div className="max-w-[1920px] mx-auto px-2">
        <div ref={imageRef} className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl group">
          <motion.div style={{ y: imageY }} className="relative h-[450px] sm:h-[400px] md:h-[500px]">
            <Image 
              src="/lovable-assets/cultivation-contrast-hq.jpg"
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-4 sm:px-8 md:px-16">
            <div className="bg-[#1A3C3A]/60 backdrop-blur-md rounded-2xl p-6 sm:p-8 md:p-10 max-w-3xl border border-white/10 shadow-2xl">
              <h2 className="text-2xl sm:text-4xl md:text-5xl font-semibold text-white mb-3 sm:mb-6 tracking-tight leading-tight drop-shadow-lg">
                Production & Processing Excellence
              </h2>
              <p className="text-white/95 text-xs sm:text-base md:text-lg leading-relaxed mb-4 sm:mb-8 drop-shadow-md">
              ...
              <Link 
                href="#" 
                className="text-primary hover:text-white font-semibold text-sm sm:text-lg transition-all inline-flex items-center gap-2 group/link bg-primary/20 hover:bg-primary px-6 py-3 rounded-full border border-primary/50 hover:border-primary shadow-lg hover:shadow-primary/50"
              >
