...
export default function Footer({ businessName, consultationUrl, productsUrl, contactUrl, logoUrl }: FooterProps) {
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex items-center gap-2 text-white/60 text-xs">
                ...
                <a href="mailto:info@healingbuds.com" className="hover:text-white transition-colors">
            ...
            <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2.5">
                  <li>
                    <Link href="#" className="text-sm text-white/60 hover:text-white transition-colors inline-block">
                      About Us
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2.5">
                  <li>
                    <Link href={contactUrl || "#"} className="text-sm text-white/60 hover:text-white transition-colors inline-block">
                      Patient Access
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link href="#news" className="text-sm text-white/60 hover:text-white transition-colors inline-block">
                      News & Updates
                    </Link>
                  </li>
                </ul>
