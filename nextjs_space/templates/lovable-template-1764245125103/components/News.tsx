...
const newsItems = [
  {
    ...
    image: "/lovable-assets/award-hq.jpg",
    featured: true,
  },
  {
    ...
    image: "/lovable-assets/products-mental-health.jpg",
    featured: false,
  },
  {
    ...
    image: "/lovable-assets/conference-hq.jpg",
    featured: false,
  },
];
          ...
          {newsItems.map((item, index) => (
            ...
            >
              ...
              <div className="p-6">
                <Badge 
                  variant="outline" 
                  className="mb-3 border-secondary/60 text-secondary bg-secondary/10 rounded-full px-3 py-1"
                >
                  {item.category}
                </Badge>
                <h3 className="text-xl font-semibold text-foreground mb-2 leading-tight group-hover:text-primary transition-colors tracking-tight">
                  {item.title}
                </h3>
                {item.description && (
