...
const TEMPLATES = [
  ...
  },
  {
    id: 'medical',
    name: 'Medical Blue',
    description: 'Professional healthcare aesthetic',
    primaryColor: '#3b82f6',
            ...
            {selectedTemplate && (
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-xs text-green-800 mb-3">
                  Your store will use these colors. You can customize everything later from your admin dashboard.
                </p>
                <div className="flex gap-2">
                  <div className="flex-1 p-3 rounded" style={{ backgroundColor: selectedTemplate.primaryColor }}>
                    <div className="text-white text-xs font-medium">Primary Color</div>
                  </div>
                  <div className="flex-1 p-3 rounded" style={{ backgroundColor: selectedTemplate.secondaryColor }}>
                    <div className="text-white text-xs font-medium">Secondary Color</div>
                  </div>
                </div>
              </div>
            )}
