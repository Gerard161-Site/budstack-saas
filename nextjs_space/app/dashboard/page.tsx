          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/store/healingbuds/products">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
              ...
              <div className="space-y-3">
                ...
                <Link href="/store/healingbuds/products" className="block">
            ...
            <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
              ...
              <div className="space-y-2 text-sm">
                ...
                <Link href="/conditions" className="block text-blue-700 hover:text-blue-900 hover:underline">
                  → Treatable Conditions
                </Link>
                <Link href="/faq" className="block text-blue-700 hover:text-blue-900 hover:underline">
                  → FAQ
                </Link>
                <Link href="/blog" className="block text-blue-700 hover:text-blue-900 hover:underline">
                  → Blog & Articles
                </Link>
              </div>
            </div>
