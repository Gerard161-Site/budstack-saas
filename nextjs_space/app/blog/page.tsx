          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                Expert insights, patient stories, and the latest news on medical cannabis in Portugal.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-gradient-to-br from-green-600 to-green-800 rounded-2xl overflow-hidden shadow-2xl">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="p-12 flex flex-col justify-center text-white">
                  ...
                  <Button className="bg-white text-green-900 hover:bg-gray-100 w-fit" disabled>
